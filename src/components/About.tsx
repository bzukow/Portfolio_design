    ...
    return (
        <section className="about" id="about">
            ...
            <div className="about-text">
                ...
                <p className="reveal">
                    I've been drawing since childhood, and illustration is still an important part of my creative process. I like experimenting with different visual directions and treating projects as a space for exploration rather than a fixed style or outcome. 
                </p>

                <p className="reveal">Today, I continue to develop both my technical and artistic skills, combining them in projects that sit somewhere between code and visual storytelling.</p>
            </div>
        </section>
    );
}
